  ...
  return (
    <article className="pt-[92px]">
      ...
      <div className="grid-max py-12" data-animate="rise">
        <Link href="/work" className="text-sm text-white/60 transition hover:text-white">
          ← Back to work
        </Link>
        <h1 className="mt-6 text-3xl font-bold md:text-4xl">{caseStudy.title}</h1>
        <p className="mt-4 max-w-3xl text-white/70 md:text-lg">{caseStudy.summary}</p>
        ...
        <dl className="mt-6 grid gap-4 rounded-2xl border border-night-700/60 bg-night-900/60 p-6 text-sm text-white/70">
          <div>
            <dt className="text-xs uppercase tracking-[0.3em] text-mint-300">Engagement type</dt>
            <dd className="mt-1">Rapid discovery, prototype, and pilot enablement</dd>
          </div>
        </dl>
        <div className="mt-10 max-w-3xl space-y-5 text-white/80">
          <p>
